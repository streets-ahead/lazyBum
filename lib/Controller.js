...
var initRestful = function(col) {
	...
	Controller.prototype.index_get = function(urlParts, query) {
		var self = this;
		self.internalGet(urlParts, query, function(results, err) {
			if(err) {
	...
	Controller.prototype.index_post = function(urlParts, query, postData) {
		var self = this;
		self.internalPost(urlParts, query, post, function(results, errors) {
			if(errors) {
				var data = {
					inputData: postData,
					errors: errors
	...
	Controller.prototype.internalGet = function(urlParts, query, callback) {
		var self = this;
		var qs = {};
	...
	Controller.prototype.internalPost = function(urlString, query, postData, callback) {
		var self = this;
	...
	Controller.prototype.internalPut = function() {
	
	}
	
	Controller.prototype.internalDelete = function() {
